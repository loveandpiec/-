...
Enemy::Enemy()
{
...

	{
		...
		{
			AnimationGroup& anmaiton_fall = animation_pool["fall"];

			Animation& anmaiton_fall_left = anmaiton_fall.left;
			anmaiton_fall_left.set_interval(0.1f);
			anmaiton_fall_left.set_loop(true);
			anmaiton_fall_left.set_anchor_mode(Animation::AnchorMode::BottomCentered);
			anmaiton_fall_left.add_frame(ResourcesManager::instance()->find_atlas("enemy_fall_left"));

			Animation& anmaiton_fall_right = anmaiton_fall.right;
			anmaiton_fall_right.set_interval(0.1f);
			anmaiton_fall_right.set_loop(true);
			anmaiton_fall_right.set_anchor_mode(Animation::AnchorMode::BottomCentered);
			anmaiton_fall_right.add_frame(ResourcesManager::instance()->find_atlas("enemy_fall_right"));
		}
		{
			AnimationGroup& anmaiton_idle = animation_pool["idle"];

			Animation& anmaiton_idle_left = anmaiton_idle.left;
			anmaiton_idle_left.set_interval(0.1f);
			anmaiton_idle_left.set_loop(true);
			anmaiton_idle_left.set_anchor_mode(Animation::AnchorMode::BottomCentered);
			anmaiton_idle_left.add_frame(ResourcesManager::instance()->find_atlas("enemy_idle_left"));

			Animation& anmaiton_idle_right = anmaiton_idle.right;
			anmaiton_idle_right.set_interval(0.1f);
			anmaiton_idle_right.set_loop(true);
			anmaiton_idle_right.set_anchor_mode(Animation::AnchorMode::BottomCentered);
			anmaiton_idle_right.add_frame(ResourcesManager::instance()->find_atlas("enemy_idle_right"));
		}
		{
	...
	}
	{
		...
		animation_dash_in_air_right.add_frame(ResourcesManager::instance()->find_atlas("enemy_vfx_dash_in_air_left"));
...
void Enemy::throw_babs()
{
	...
	for (int i = 0; i < num_new_barb; i++)
	{
		...
		new_barb->set_postion({ (float)rand_x,(float)rand_y });
